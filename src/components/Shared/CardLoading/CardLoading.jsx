const CardLoading = () => {
  return (
    // <div className="flex min-h-screen flex-col justify-center bg-gray-900 py-12 px-4">
      <div className="relative bg-white  shadow-xl ring-1 ring-gray-900/5 rounded-lg">
        <div className=" animate-pulse">
          ...
          <div className="flex flex-col justify-center items-center w-11/12 mx-auto py-10">

    ...
    <div className="text-white bg-white/10 shadow-inner shadow-white rounded-b-full">
      ...
      <div className="items-center text-center py-10 px-10 space-y-5">
        ...
        <div className="flex justify-center items-center">
          <button className="text-white py-5 px-8 rounded-full bg-white/5 border-b-4 uppercase text-xl font-medium hover:bg-brand-color hover:border-white transition-colors duration-300 border-brand-color">
            Buy Now
          </button>
        </div>
      </div>

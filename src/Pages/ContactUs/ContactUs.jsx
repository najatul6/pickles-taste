            ...
            <form className="flex flex-col justify-center items-center gap-6">
              <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-6">
                ...
                <div className="w-full flex flex-col justify-center items-start gap-4">
                  <label htmlFor="name" className="text-white text-xl font-bold">Name*</label>
                  <input
              ...
              {/* Phone Field  */}
              <div className="w-full flex flex-col justify-center items-start gap-4">
                <label htmlFor="phone" className="text-white text-xl font-bold">Phone*</label>
                <input
                className="w-full rounded-xl shadow-xl py-7 px-8 bg-white/10 text-brand-color focus:outline-none focus:font-bold"
                  type="tel"
                  name="phone"
              ...
              {/* Message Field  */}
              <div className="w-full flex flex-col justify-center items-start gap-4">
                <label htmlFor="message" className="text-white text-xl font-bold">Message*</label>
                <textarea
                className="w-full h-36 rounded-xl shadow-xl py-7 px-8 bg-white/10 text-brand-color focus:outline-none focus:font-bold" name="message" placeholder="Enter Your Message" />
              </div>
